...
- In Review — 구현 완료, 동작 어긋남 판단 전 ([상태의 뜻](../../CLAUDE.md#기능-상태의-뜻) · [PR #57](https://github.com/easyDong19/dongmodoro/pull/57)).
  목록·인라인 편집·완료 토글·삭제 확인·표시 모드 5분기·달성 배지·주 단위 롤업·
  직전 달 제목 복사까지 섰다. 보관 개념은 도입 후 제거됐다 (ADR-034).
  **수동 순서 변경과 월 누적 소진은 여전히 비범위**이며,
  월말 정산의 마일스톤 재설정 흐름도 v1 밖 그대로다.

- UI 카피는 코드와 맞췄다 (2026-09-25). 남은 동작 어긋남은 [tmp 목록](../../tmp/spec-behavior-mismatches.md) 에 있다.
