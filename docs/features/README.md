...
| today-tasks | In Review | [overview](./today-tasks/overview.md) | prd | 오늘 목록 — 주간 task 를 가져와 지금 할 일을 고른다 |
| week-plan | In Review | [overview](./week-plan/overview.md) | prd, ux-spec | Sprint — 이번 주에 뭘 할지를 제목으로 잡고 요일에 배치한다 |
| milestones | In Review | [overview](./milestones/overview.md) | prd | 월간 Milestone. 수치 없이 상태로 기술 |
...
| pomo-baseline | Published | [overview](./pomo-baseline/overview.md) | prd | 뽀모 길이 3종의 소유자 |
