...
- Published — 스펙·코드 대조 완료, 어긋남 없음 (2026-09-25, [상태의 뜻](../../CLAUDE.md#기능-상태의-뜻)). 길이 편집은 대기 중인 타이머의 ± 칩 하나로 단일화됐다 (ADR-033).
  대기 중 조절이 그 모드의 기준을 즉시 저장하며, 정산 패널의 진입점은 폐기됐다.
  첫 실행 온보딩은 두지 않는다 — 새 설치의 기본값은 시딩이 담당한다 (app-shell R31 폐기).
