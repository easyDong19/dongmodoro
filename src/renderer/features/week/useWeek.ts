...
export function useWeek() {
  ...
  /**
   * 마일스톤 연결 (milestones R13 · ADR-035). 같은 `invalidateItem` 을 쓰되 **월 카드도 함께**
   * 턴다 — 연결이 바뀌면 옛 Milestone 과 새 Milestone 의 롤업이 달라진다. 두 달은 응답의
   * `months` 에서 온다. 연결이 어느 달에나 걸리므로 주에서 달을 파생할 수 없다.
   */
